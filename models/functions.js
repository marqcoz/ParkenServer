...
functions.buscarEspacioParken = function(latitud, longitud, distance, callback){
 ...
 'WHERE idzonaparken != 0 AND idzonaparken != 1 AND estatus = \'DISPONIBLE\' AND sDistance.distancia <= ~2) 
 */
 'AND eParken.zonaparken_idzonaparken IN (SELECT * FROM zonaparken WHERE estatus = \'DISPONIBLE\') AND eParken.estatus = \'DISPONIBLE\' AND eParken.idespacioparken != 0 ORDER BY idespacioparken limit 1;';				   
